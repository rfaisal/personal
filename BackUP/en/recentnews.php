<?php 
	...
	$sql_select_quary = "SELECT RecentNews.EventID, RecentNews.Title, RecentNews.`Desc`, RecentNews.Date FROM RecentNews ORDER BY RecentNews.Date DESC";
	$sql_count_quary = "SELECT count(RecentNews.EventID) as TotalNews FROM RecentNews";
