...
SELECT c.lastname||', '||c.givennames as "name", c.university, c.talklength
...
FETCHROWSFROMDB;
        ...
        $stmt->execute();
        if ($stmt->rowCount() > 0) {
            echo "<table id='registrantlist' CELLPADDING='0' CELLSPACING='15'><tr><th>Name</th><th>University</th><th>Talk Length</th></tr>\n";
